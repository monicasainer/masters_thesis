...
# %% [markdown]
# ## Statistical Significance - Table 2 . Proxy C
...
# ### **Proxy C :**
#
# Daily abnormal stock returns with absolute values exceeding small_thres and 10% using Market Model Adjusted Returns by market returns sign.
...
results_significance_c_eight_increase_alt_m_dec = pd.DataFrame(results_dict_c_eight_increase_alt_m)
...
results_significance_c_ten_increase_alt_m_dec = pd.DataFrame(results_dict_c_ten_increase_alt_m)
...
# %%
results_significance_c_eight_increase_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_eight_increase_m.xlsx')
results_significance_c_ten_increase_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_ten_increase_m.xlsx')

results_significance_c_eight_increase_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_eight_increase_alt_result_m_dec.xlsx')
results_significance_c_ten_increase_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_ten_increase_alt_result_m_dec.xlsx')

results_significance_c_eight_increase_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_eight_increase_m_dec.xlsx')
results_significance_c_ten_increase_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_ten_increase_m_dec.xlsx')

results_significance_c_eight_increase_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_eight_increase_alt_result_m.xlsx')
results_significance_c_ten_increase_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_ten_increase_alt_result_m.xlsx')

results_significance_c_eight_decrease_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_eight_decrease_m.xlsx')
results_significance_c_ten_decrease_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_ten_decrease_m.xlsx')

results_significance_c_eight_decrease_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_eight_decrease_alt_result_m.xlsx')
results_significance_c_ten_decrease_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_ten_decrease_alt_result_m.xlsx')

results_significance_c_eight_decrease_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_eight_decrease_m_dec.xlsx')
results_significance_c_ten_decrease_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_ten_decrease_m_dec.xlsx')

results_significance_c_eight_decrease_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_eight_decrease_alt_result_m_dec.xlsx')
results_significance_c_ten_decrease_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_c_ten_decrease_alt_result_m_dec.xlsx')

...
# %%
ARs_df.to_excel(f'{path}/raw_data/post_covid/ARs_df.xlsx')
...
# %%
results_significance_a_eight_increase.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_a_eight_increase.xlsx')
results_significance_a_eight_decrease.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_a_eight_decrease.xlsx')
results_significance_a_ten_increase.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_a_ten_increase.xlsx')
results_significance_a_ten_decrease.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_a_ten_decrease.xlsx')

results_significance_b_three_increase.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_b_three_increase.xlsx')
results_significance_b_three_decrease.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_b_three_decrease.xlsx')
results_significance_b_four_increase.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_b_four_increase.xlsx')
results_significance_b_four_decrease.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_b_four_decrease.xlsx')


# %%
results_significance_a_eight_increase_alt_result.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_a_eight_increase_alt_result.xlsx')
results_significance_a_eight_decrease_alt_result.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_a_eight_decrease_alt_result.xlsx')
results_significance_a_ten_increase_alt_result.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_a_ten_increase_alt_result.xlsx')
results_significance_a_ten_decrease_alt_result.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_a_ten_decrease_alt_result.xlsx')

results_significance_b_three_increase_alt_result.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_b_three_increase_alt_result.xlsx')
results_significance_b_three_decrease_alt_result.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_b_three_decrease_alt_result.xlsx')
results_significance_b_four_increase_alt_result.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_b_four_increase_alt_result.xlsx')
results_significance_b_four_decrease_alt_result.to_excel(f'{path}/raw_data/post_covid/t1_results_significance_b_four_decrease_alt_result.xlsx')

...
# %%
tickers= pd.read_excel(f"{path}/raw_data/pre_covid/Weightings_20240216_OMXSPI.xlsx",header=0)
...
# %%
data.to_csv(f"{path}/raw_data/pre_covid/raw_data.csv")
...
# %%
l_caps=pd.read_excel(f"{path}/raw_data/pre_covid/large_caps.xlsx")
l_caps_list=l_caps['Security-Symbol'].to_list()


# %%
m_caps=pd.read_excel(f"{path}/raw_data/pre_covid/mid_caps.xlsx")
m_caps_list=m_caps['Security-Symbol'].to_list()


# %%
s_caps=pd.read_excel(f"{path}/raw_data/pre_covid/small_caps.xlsx")
...
# %%
df_null_percentage.to_excel(f'{path}/raw_data/pre_covid/null_percentage.xlsx')
...
proxy_a_df.to_excel(f'{path}/raw_data/pre_covid/proxy_a.xlsx')
...
price_2013.to_csv(f'{path}/raw_data/pre_covid/price_2013.csv')
...
proxy_b_df.to_excel(f'{path}/raw_data/pre_covid/proxy_b.xlsx')
...
proxy_c_df.to_excel(f"{path}/raw_data/pre_covid/proxy_c.xlsx")

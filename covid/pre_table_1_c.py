...
# %%
results_significance_c_eight_increase.to_excel(f'{path}/raw_data/pre_covid/t1_results_significance_c_eight_increase.xlsx')
results_significance_c_eight_decrease.to_excel(f'{path}/raw_data/pre_covid/t1_results_significance_c_eight_decrease.xlsx')
results_significance_c_ten_increase.to_excel(f'{path}/raw_data/pre_covid/t1_results_significance_c_ten_increase.xlsx')
results_significance_c_ten_decrease.to_excel(f'{path}/raw_data/pre_covid/t1_results_significance_c_ten_decrease.xlsx')


# %%
results_significance_c_eight_increase_alt_result.to_excel(f'{path}/raw_data/pre_covid/t1_results_significance_c_eight_increase_alt_result.xlsx')
results_significance_c_eight_decrease_alt_result.to_excel(f'{path}/raw_data/pre_covid/t1_results_significance_c_eight_decrease_alt_result.xlsx')
results_significance_c_ten_increase_alt_result.to_excel(f'{path}/raw_data/pre_covid/t1_results_significance_c_ten_increase_alt_result.xlsx')
results_significance_c_ten_decrease_alt_result.to_excel(f'{path}/raw_data/pre_covid/t1_results_significance_c_ten_decrease_alt_result.xlsx')

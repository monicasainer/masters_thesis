...
# %%
results_significance_b_three_increase_m.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_three_increase_m_mid.xlsx')
results_significance_b_four_increase_m.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_four_increase_m_mid.xlsx')

results_significance_b_three_increase_alt_result_m.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_three_increase_alt_result_m_mid.xlsx')
results_significance_b_four_increase_alt_result_m.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_four_increase_alt_result_m_mid.xlsx')

results_significance_b_three_increase_m_dec.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_three_increase_m_dec_mid.xlsx')
results_significance_b_four_increase_m_dec.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_four_increase_m_dec_mid.xlsx')

results_significance_b_three_increase_alt_result_m_dec.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_three_increase_alt_result_m_dec_mid.xlsx')
results_significance_b_four_increase_alt_result_m_dec.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_four_increase_alt_result_m_dec_mid.xlsx')

results_significance_b_three_decrease_m.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_three_decrease_m_mid.xlsx')
results_significance_b_four_decrease_m.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_four_decrease_m_mid.xlsx')

results_significance_b_three_decrease_alt_result_m.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_three_decrease_alt_result_m_mid.xlsx')
results_significance_b_four_decrease_alt_result_m.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_four_decrease_alt_result_m_mid.xlsx')

results_significance_b_three_decrease_m_dec.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_three_decrease_m_dec_mid.xlsx')
results_significance_b_four_decrease_m_dec.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_four_decrease_m_dec_mid.xlsx')

results_significance_b_three_decrease_alt_result_m_dec.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_three_decrease_alt_result_m_dec_mid.xlsx')
results_significance_b_four_decrease_alt_result_m_dec.to_excel(f'{path}/raw_data/pre_covid/t3_results_significance_b_four_decrease_alt_result_m_dec_mid.xlsx')

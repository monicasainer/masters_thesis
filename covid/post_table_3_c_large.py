...
# %%
results_significance_c_eight_increase_m.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_eight_increase_m_large.xlsx')
results_significance_c_ten_increase_m.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_ten_increase_m_large.xlsx')

results_significance_c_eight_increase_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_eight_increase_alt_result_m_large.xlsx')
results_significance_c_ten_increase_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_ten_increase_alt_result_m_large.xlsx')

results_significance_c_eight_increase_m_dec.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_eight_increase_m_dec_large.xlsx')
results_significance_c_ten_increase_m_dec.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_ten_increase_m_dec_large.xlsx')

results_significance_c_eight_increase_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_eight_increase_alt_result_m_dec_large.xlsx')
results_significance_c_ten_increase_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_ten_increase_alt_result_m_dec_large.xlsx')

results_significance_c_eight_decrease_m.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_eight_decrease_m_large.xlsx')
results_significance_c_ten_decrease_m.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_ten_decrease_m_large.xlsx')

results_significance_c_eight_decrease_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_eight_decrease_alt_result_m_large.xlsx')
results_significance_c_ten_decrease_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_ten_decrease_alt_result_m_large.xlsx')

results_significance_c_eight_decrease_m_dec.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_eight_decrease_m_dec_large.xlsx')
results_significance_c_ten_decrease_m_dec.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_ten_decrease_m_dec_large.xlsx')

results_significance_c_eight_decrease_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_eight_decrease_alt_result_m_dec_large.xlsx')
results_significance_c_ten_decrease_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t3_results_significance_c_ten_decrease_alt_result_m_dec_large.xlsx')

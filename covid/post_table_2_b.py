...
# %% [markdown]
# ## Statistical Significance - Table 2. Proxy b
...
# ### **Proxy B :**
#
# Daily raw stock returns with absolute values exceeding 3 and 4 standard deviations by market returns sign.

# %%
proxy_b_df = pd.read_excel(f'{path}/raw_data/post_covid/proxy_b.xlsx')
...
results_significance_b_four_increase_alt_m_dec = pd.DataFrame(results_dict_b_four_increase_alt_m)
...
# %%
results_significance_b_three_increase_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_three_increase_m.xlsx')
results_significance_b_four_increase_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_four_increase_m.xlsx')

results_significance_b_three_increase_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_three_increase_alt_result_m.xlsx')
results_significance_b_four_increase_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_four_increase_alt_result_m.xlsx')

results_significance_b_three_increase_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_three_increase_m_dec.xlsx')
results_significance_b_four_increase_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_four_increase_m_dec.xlsx')

results_significance_b_three_increase_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_three_increase_alt_result_m_dec.xlsx')
results_significance_b_four_increase_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_four_increase_alt_result_m_dec.xlsx')

results_significance_b_three_decrease_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_three_decrease_m.xlsx')
results_significance_b_four_decrease_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_four_decrease_m.xlsx')

results_significance_b_three_decrease_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_three_decrease_alt_result_m.xlsx')
results_significance_b_four_decrease_alt_result_m.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_four_decrease_alt_result_m.xlsx')

results_significance_b_three_decrease_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_three_decrease_m_dec.xlsx')
results_significance_b_four_decrease_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_four_decrease_m_dec.xlsx')

results_significance_b_three_decrease_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_three_decrease_alt_result_m_dec.xlsx')
results_significance_b_four_decrease_alt_result_m_dec.to_excel(f'{path}/raw_data/post_covid/t2_results_significance_b_four_decrease_alt_result_m_dec.xlsx')
